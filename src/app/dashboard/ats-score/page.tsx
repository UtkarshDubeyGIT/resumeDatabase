    ...
    <div className="px-6 lg:px-10 py-16 max-w-lg">
      <div className="animate-fade-up">
        <div className="w-12 h-12 rounded-[var(--radius-lg)] bg-muted-bg border border-edge flex items-center justify-center mb-6">
          <ChartBar size={22} className="text-content-muted" weight="regular" />
        </div>
        ...
        <h1 className="font-display text-2xl font-bold tracking-tight text-content">ATS Score</h1>
        <p className="text-content-muted mt-2 text-sm leading-relaxed">
          Get a detailed ATS compatibility score for each resume before you apply.
        </p>
